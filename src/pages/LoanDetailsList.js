...
function LoanDetailsList() {
  ...
  useEffect(() => {
    const fetchLoans = async () => {
      try {
        ...
        console.log(`Query returned ${querySnapshot.docs.length} loan documents`);
        ...
        try {
          ...
          if (snapshot.docs.length > 0) {
            ...
            console.log(`Found ${snapshot.docs.length} loan documents with simple query`);
  ...
  const filteredLoans = selectedLoanType === 'All Types'
    ? loans
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-white shadow-md rounded-lg p-6 mb-6">
        <div className="mb-4">
          <label htmlFor="loan-type-filter" className="block text-gray-700 font-medium mb-2">
            Filter by Loan Type
          </label>
          <select
            id="loan-type-filter"
      ...
      {loading ? (
        ...
        <div className="bg-yellow-50 border border-yellow-200 text-yellow-800 px-4 py-8 rounded-lg text-center">
          ...
          <p className="mt-2">Try selecting a different loan type or add new loan details.</p>
          <button
            onClick={() => navigate('/loan-details/new')}
            ...
            >
              <div className="p-6">
                <div className="flex justify-between items-start mb-4">
                  ...
                  <span className="bg-green-100 text-green-800 text-xs px-2 py-1 rounded-full">{loan.loanType}</span>
                </div>
                ...
                <div className="border-t border-gray-100 pt-4 mt-4">
                  <div className="flex justify-between items-center text-sm">
                    <div className="text-gray-700">
                      ...
                      <p>Amount: <span className="font-medium">₹{loan.minAmount?.toLocaleString() || 0} - ₹{loan.maxAmount?.toLocaleString() || 0}</span></p>
                    </div>
